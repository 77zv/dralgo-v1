...
def run_backtest(callback: Callable, initial_balance: float, risk : float, num_months: int):
    ...
    for i in range(num_months):
        ...
        balance: float = backtesting_dr(data, "9:30", "10:30", balance, risk)

    print(f"\n Final Balance: {balance}")

run_backtest(backtesting_dr, 10000, 0.02, 12)
